...
import time
import math
from untils import scale_image, blit_rotate_center
...
GREY_CAR = pygame.image.load("imgs/green-car.png")
PURPLE_CAR = pygame.image.load("imgs/purple-car.png")

WIDTH, HEIGT = TRACK.get_width(), TRACK.get_height()
...
while run:
    ...
    if player_car.colide(TRACK_BORDER_MASK) !=None:
        player_car.bounce()
